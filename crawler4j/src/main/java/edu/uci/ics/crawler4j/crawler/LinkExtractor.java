...
/**
 * This class is almost a copy/paste of it.unimi.dsi.parser.callback.LinkExtractor but with support for extracting image
 * sources. The original class didn't allow overriding
 */
...
public class LinkExtractor extends DefaultCallback
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.unimi.dsi.parser.callback.DefaultCallback#startDocument()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.unimi.dsi.parser.callback.DefaultCallback#startElement(it.unimi.dsi.parser.Element, java.util.Map)
	 */
		...
		if (element == Element.META)
		{
			...
			if (equiv != null && content != null)
			{
				...
				if (equiv.equals("refresh") && (metaRefresh == null))
				{
					...
					if (pos != -1) metaRefresh = content.substring(pos + URLEQUAL_PATTERN.length()).toString();
				}

				// http-equiv="location" content="http://foo.bar/..."
				if (equiv.equals("location") && (metaLocation == null)) metaLocation = attrMap.get(Attribute.CONTENT)
						.toString();
			}
		}
	...
	/**
	 * Checks if is include images sources.
	 * 
	 * @return true, if is include images sources
	 */
	...
	/**
	 * Sets the include images sources.
	 * 
	 * @param includeImagesSources
	 *            the new include images sources
	 */
