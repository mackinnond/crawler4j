...
public class HTMLParser
{
	...
	public HTMLParser()
	{
		...
		linkExtractor.setIncludeImagesSources(Configurations.getBooleanProperty("crawler.include_images", false));
	}
	...
	public void parse(String htmlContent, String contextURL)
	{
		...
		while (it.hasNext())
		{
			...
			if (hrefWithoutProtocol.indexOf("javascript:") < 0 && hrefWithoutProtocol.indexOf("@") < 0)
			{
